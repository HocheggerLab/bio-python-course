...
export const NOTEBOOK_CONDITIONALS_BASICS = `${COLAB_BASE}/lab03/03_conditionals_basics.ipynb`
export const NOTEBOOK_CONDITIONALS_ADVANCED = `${COLAB_BASE}/lab03/04_conditionals_advanced_concepts.ipynb`
