...
export const NOTEBOOK_LOOPS_BASICS = `${COLAB_BASE}/lab03/01_loops_basics.ipynb`
export const NOTEBOOK_LOOPS_ADVANCED = `${COLAB_BASE}/lab03/02_loops_advanced_concepts.ipynb`
