...
export const NOTEBOOK_STRINGS_BASICS = `${COLAB_BASE}/lab02/03_strings_basics.ipynb`
export const NOTEBOOK_STRINGS_ADVANCED = `${COLAB_BASE}/lab02/04_strings_advanced_concepts.ipynb`
