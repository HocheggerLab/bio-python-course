...
export const lab3VsCodeData: LectureData = {
  ...
  slides: [
    { id: 1, title: "What's an IDE?",      contentType: 'top', content: <Slide01WhatIsIde /> },
    { id: 2, title: 'Meet the IDEs',       contentType: 'top', content: <Slide02MeetIdes /> },
    { id: 3, title: 'The VS Code window',  contentType: 'top', content: <Slide03Window /> },
    { id: 4, title: 'The workflow',        contentType: 'top', content: <Slide04Workflow /> },
