...
export const NOTEBOOK_LISTS_BASICS = `${COLAB_BASE}/lab02/01_lists_basics.ipynb`
export const NOTEBOOK_LISTS_ADVANCED = `${COLAB_BASE}/lab02/02_lists_advanced_concepts.ipynb`
