...
export const NOTEBOOK_DICTS_BASICS = `${COLAB_BASE}/lab02/05_dictionaries_basics.ipynb`
export const NOTEBOOK_DICTS_ADVANCED = `${COLAB_BASE}/lab02/06_dictionaries_advanced_concepts.ipynb`
