        ...
        <div className="flex flex-col gap-3 md:gap-4 min-h-0">
          <SlideCard color="blue" layout="start" padding="compact" className="border-l-4">
            <CardHeading size="sm" color="blue" className="mb-2 md:mb-3">
              Tools Python gives you for free
            </CardHeading>
            <CardBody>
              A <strong>built-in function</strong> works out of the box — no{' '}
              <span className="font-mono">import</span> needed. You hand it a value, it gives
              something back. The pattern is always the same:{' '}
        ...
        <div className="flex flex-col gap-3 md:gap-4 min-h-0">
          <SlideCard color="yellow" layout="start" padding="compact" className="border-l-4">
            ...
            <CardBody>
              ...
              <span className="font-mono text-bio-yellow">help()</span> and Python prints the
              official documentation right there — works on <em>any</em> function.
            </CardBody>
          </SlideCard>
