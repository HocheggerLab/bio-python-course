...
import { Slide02bTwoWords } from './Slide02bTwoWords'
...
export const lecture5Data: LectureData = {
  ...
  slides: [
    ...
    { id: 2, title: 'Can You Hear a Word With Your Whiskers?', contentType: 'center', content: <Slide02TheProblem /> },
    { id: 3, title: 'Same Four Buzzes — Different Order',  contentType: 'center', content: <Slide02bTwoWords /> },
