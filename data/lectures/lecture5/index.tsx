...
export const lecture5Data: LectureData = {
  ...
  slides: [
    ...
    { id: 2, title: 'What Happens When You Touch a Whisker?', contentType: 'center', content: <Slide02TheProblem /> },
    { id: 3, title: 'One Neuron, 21,238 Numbers',          contentType: 'center', content: <Slide02cRecording /> },
    { id: 4, title: 'This Session — Arrays',               contentType: 'center', content: <Slide03ThisSession /> },
    // ── Part 1: packages (via random) ──────────────────────
    { id: 5, title: 'Two Kinds of Package',              contentType: 'center', content: <Slide04Packages /> },
    { id: 6, title: 'A First Package — random',          contentType: 'center', content: <Slide05RandomGame /> },
    // ── Part 2: a detour into OOP ──────────────────────────
    { id: 7, title: 'How Does random Actually Work?',    contentType: 'center', content: <Slide06RandomQuestion /> },
    { id: 8, title: "Use It, Don't Build It",            contentType: 'center', content: <Slide06bLaundry /> },
    { id: 9, title: 'Build the Simplest Object',         contentType: 'center', content: <Slide07Objects /> },
    { id: 10, title: 'Methods — Why numpy Looks Familiar', contentType: 'center', content: <Slide08MethodsBridge /> },
    { id: 11, title: "Try it Yourself — Drive an Object You Didn't Write", contentType: 'center', content: <Slide09TIYNeuronTrace /> },
