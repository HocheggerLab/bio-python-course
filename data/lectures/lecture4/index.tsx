...
export const lecture4Data: LectureData = {
  ...
  slides: [
    // ── Intro ──────────────────────────────────────────────
    { id: 1, title: 'Recap — Session 3',              contentType: 'center', content: <Slide01Recap /> },
    ...
    { id: 6, title: 'Break Down — the Other Strand',  contentType: 'center', content: <Slide06ReverseComplement /> },
    { id: 7, title: 'TIY — Break It Down',            contentType: 'center', content: <Slide07TIYDecompose /> },
    { id: 8, title: 'Chains Get Long',                contentType: 'center', content: <Slide08ChainsToFunctions /> },
    // ── Part 2: functions — where we're heading… ───────────
    { id: 9,  title: 'Packaging It Up — def',         contentType: 'center', content: <Slide09Def /> },
    // …now build it from nothing, one idea per slide
    { id: 10, title: 'The Simplest Function',         contentType: 'center', content: <Slide09aSimplest /> },
    { id: 11, title: 'Give It Something to Work On',  contentType: 'center', content: <Slide09bParameter /> },
    { id: 12, title: 'Naming Functions',              contentType: 'center', content: <Slide09cNaming /> },
    { id: 13, title: 'Hand the Answer Back — return', contentType: 'center', content: <Slide09dReturn /> },
    { id: 14, title: 'Two Parameters — and a Default', contentType: 'center', content: <Slide09eDefaults /> },
    // …and back to the full picture
    { id: 15, title: 'Why Bother? Readable · Reusable', contentType: 'center', content: <Slide10WhyFunctions /> },
    { id: 16, title: 'Say What It Does — docstrings', contentType: 'center', content: <Slide11Docstrings /> },
    { id: 17, title: 'TIY — Package the Spaghetti',   contentType: 'center', content: <Slide12TIYPackageGC /> },
    // ── Part 3: defensive programming ──────────────────────
    { id: 18, title: 'Real Data Is Messy',            contentType: 'center', content: <Slide17DefensiveCrash /> },
    { id: 19, title: 'Check First — the if guard',    contentType: 'center', content: <Slide18GuardFix /> },
    { id: 20, title: 'Fail Loudly — raise',           contentType: 'center', content: <Slide19Raise /> },
    { id: 21, title: 'The Advanced Pattern — try / except', contentType: 'center', content: <Slide20TryExcept /> },
    { id: 22, title: 'Which One? if vs try / except', contentType: 'center', content: <Slide21WhenWhich /> },
    { id: 23, title: 'TIY — A Defensive Function',    contentType: 'center', content: <Slide22TIYCleanDna /> },
    // ── Wrap-up: capstone · course recap · outlook ─────────
    { id: 24, title: "Claudia's Whole Job — One Program", contentType: 'center', content: <Slide23Capstone /> },
