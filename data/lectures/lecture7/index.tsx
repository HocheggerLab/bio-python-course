...
export const lecture7Data: LectureData = {
  ...
  slides: [
    ...
    { id: 12, title: 'You can now read every line',          contentType: 'center', content: <Slide13Bookend /> },

    { id: 13, title: 'Recall — who owns the title?',         contentType: 'center', content: <Slide14RecallTitle /> },
  ],
}
