...
export const lecture2Data: LectureData = {
  ...
  slides: [
    // ── Intro ──────────────────────────────────────────────
    { id: 1, title: 'Recap — Session 1',         contentType: 'center', content: <Slide01Recap /> },
    ...
    // ── Block 1: Lists ─────────────────────────────────────
    { id: 4, title: 'Lists',                      contentType: 'center', content: <Slide04Lists /> },
    { id: 5, title: 'Indexing & Slicing',         contentType: 'center', content: <Slide05IndexingSlicing /> },
    { id: 6, title: 'Growing a List',             contentType: 'center', content: <Slide06GrowingList /> },
    { id: 7, title: 'Editing a List',             contentType: 'center', content: <Slide07EditingList /> },
    { id: 8,  title: 'Lists Hold Anything',       contentType: 'center', content: <Slide08ListsHoldAnything /> },
    { id: 9,  title: 'Lists of Numbers',          contentType: 'center', content: <Slide09NumberLists /> },
    { id: 10, title: 'TIY — Clean data, find the mean', contentType: 'center', content: <Slide10TIYMean /> },
    // ── Block 2: Strings are sequences ─────────────────────
    { id: 11, title: 'A String Is a Sequence',    contentType: 'center', content: <Slide11StringIsSequence /> },
    { id: 12, title: 'How Big Is a Character?',   contentType: 'center', content: <Slide12Encoding /> },
    { id: 13, title: 'Slicing Out Codons',        contentType: 'center', content: <Slide13SlicingCodons /> },
    { id: 14, title: 'TIY — Slice the codons',    contentType: 'center', content: <Slide14TIYSliceCodons /> },
    { id: 15, title: 'Building Strings',          contentType: 'center', content: <Slide15BuildingStrings /> },
    { id: 16, title: 'String Methods',            contentType: 'center', content: <Slide16StringMethods /> },
    { id: 17, title: 'Transcription with .replace()', contentType: 'center', content: <Slide17Transcription /> },
    { id: 18, title: 'TIY — Profile a sequence', contentType: 'center', content: <Slide18TIYSequenceReport /> },
    // ── Block 3: Dictionaries ──────────────────────────────
    { id: 19, title: 'Dictionaries — a lookup table', contentType: 'center', content: <Slide19CodonTable /> },
    { id: 20, title: 'Dictionaries Are Everywhere', contentType: 'center', content: <Slide20DictExamples /> },
    { id: 21, title: 'Looking Up by Key',         contentType: 'center', content: <Slide21LookupByKey /> },
    { id: 22, title: 'KeyError & .get()',         contentType: 'center', content: <Slide22KeyErrorGet /> },
    { id: 23, title: 'Building & Checking',       contentType: 'center', content: <Slide23BuildingDicts /> },
    { id: 24, title: 'TIY — Translate by lookup', contentType: 'center', content: <Slide24TIYTranslate /> },
    // ── Wrap-up ────────────────────────────────────────────
