...
export function Slide22KeyErrorGet() {
  return (
    <>
      <SlideTitle>
        When the Key Isn&apos;t There — <GradientText><span className="font-mono">.get()</span></GradientText>
      </SlideTitle>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 xl:gap-8 mt-4 md:mt-6 xl:mt-8 flex-1 min-h-0">
        ...
        <div className="flex flex-col gap-3 md:gap-4 min-h-0">
          <p className="text-gray-300 text-xs md:text-sm xl:text-base italic">
            Run it — then uncomment the <span className="font-mono not-italic">[&quot;TTT&quot;]</span> line to meet the KeyError:
          </p>
