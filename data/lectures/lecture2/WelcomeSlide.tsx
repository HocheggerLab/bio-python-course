  ...
  return (
    <>
      <SlideTitle size="xl" className="mb-4">
        Welcome to Lecture <GradientText>2</GradientText>
        <br />
        <span className="text-3xl md:text-4xl">Sequence Analysis & Python Basics</span>
      </SlideTitle>
      <p className="text-xl text-gray-300 mb-10 text-center">
        In todays project we will automate an Open Reading Frame (ORF) prediction algorithm.
      </p>
