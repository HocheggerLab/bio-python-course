...
export const assessment: AssessmentItem[] = [
  {
    ...
    covers: 'Weeks 1–3',
    submission: 'Sat in the Week 5 workshop (2-hour session)',
    detail: [
      'Multiple-choice, completed in the room rather than at home.',
  ...
  },
  {
    ...
    detail: [
      'Deliberately the smaller one: it exists so the assessment style is familiar before the project that carries the marks.',
      'You get feedback on it before Project 2 is due.',
    ],
